...
public class Room extends EnclosedSpace {
    ...
    Room(World world, PlacementInstructions initial_placement_instructions, Random rand, Board board) {
        super(world, initial_placement_instructions, rand, board);
    }
    ...
    private void set_rest_of_doors() {
        if (initial_door_side != Side.LEFT) {
            ...
            doors.add(left_door);
            world.add_unused_door(left_door);
        }
        ...
        if (initial_door_side != Side.RIGHT) {
            ...
            world.add_unused_door(right_door);
        }
        ...
        if (initial_door_side != Side.TOP) {
            ...
            doors.add(top_door);
            world.add_unused_door(top_door);
        }
        ...
        if (initial_door_side != Side.BOTTOM) {
            ...
            world.add_unused_door(bottom_door);
        }
    }
