...
public class World {
    ...
    // TODO - I should almost certainly delete this method after I finish refactoring.  A user of a world should not need to know about a board. Boards are a layer of abstraction lower.
    ...
    private double perc_full() {
        ...
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                if (board.get_cell(new Point(x, y)) != Tileset.NOTHING) {
                    cells_full++;
                }
            }
        }
